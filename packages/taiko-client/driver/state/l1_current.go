...
// TODO: REIMPLEMENT GETTING PUBLICATION BY ID HERE
...
// 	batch, err := s.FindPublicationHeaderBlockID(ctx, blockID.Uint64())
// 	if err != nil {
...
// func (s *State) FindPublicationHeaderBlockID(ctx context.Context, publicationID uint64) (*minimal.IInboxPublicationMetadata, error) {
