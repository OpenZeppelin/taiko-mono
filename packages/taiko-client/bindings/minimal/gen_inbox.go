...
var IInboxMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"publish\",\"inputs\":[{\"name\":\"nBlobs\",\"type\":\"uint256\",\"internalType\":\"uint256\"},{\"name\":\"anchorBlockId\",\"type\":\"uint64\",\"internalType\":\"uint64\"}],\"outputs\":[],\"stateMutability\":\"payable\"}]",
}
...
//
// Solidity: function publish(uint256 nBlobs, uint64 anchorBlockId) payable returns()
