...
// Prove is a paid mutator transaction binding the contract method 0xa821b2bb.
//
// Solidity: function prove((uint256,bytes32) start, (uint256,bytes32) end, (uint256,bytes32,address,uint256,uint256,bytes32) firstPub, (uint256,bytes32,address,uint256,uint256,bytes32) lastPub, uint256 numDelayedPublications, bytes proof, uint256 periodId) returns()
func (_IProverManager *IProverManagerTransactor) Prove(opts *bind.TransactOpts, start ICheckpointTrackerCheckpoint, end ICheckpointTrackerCheckpoint, firstPub IInboxPublicationHeader, lastPub IInboxPublicationHeader, numDelayedPublications *big.Int, proof []byte, periodId *big.Int) (*types.Transaction, error) {
	return _IProverManager.contract.Transact(opts, "prove", start, end, firstPub, lastPub, numDelayedPublications, proof, periodId)
}

// Prove is a paid mutator transaction binding the contract method 0xa821b2bb.
//
// Solidity: function prove((uint256,bytes32) start, (uint256,bytes32) end, (uint256,bytes32,address,uint256,uint256,bytes32) firstPub, (uint256,bytes32,address,uint256,uint256,bytes32) lastPub, uint256 numDelayedPublications, bytes proof, uint256 periodId) returns()
func (_IProverManager *IProverManagerSession) Prove(start ICheckpointTrackerCheckpoint, end ICheckpointTrackerCheckpoint, firstPub IInboxPublicationHeader, lastPub IInboxPublicationHeader, numDelayedPublications *big.Int, proof []byte, periodId *big.Int) (*types.Transaction, error) {
	return _IProverManager.Contract.Prove(&_IProverManager.TransactOpts, start, end, firstPub, lastPub, numDelayedPublications, proof, periodId)
}

// Prove is a paid mutator transaction binding the contract method 0xa821b2bb.
//
// Solidity: function prove((uint256,bytes32) start, (uint256,bytes32) end, (uint256,bytes32,address,uint256,uint256,bytes32) firstPub, (uint256,bytes32,address,uint256,uint256,bytes32) lastPub, uint256 numDelayedPublications, bytes proof, uint256 periodId) returns()
func (_IProverManager *IProverManagerTransactorSession) Prove(start ICheckpointTrackerCheckpoint, end ICheckpointTrackerCheckpoint, firstPub IInboxPublicationHeader, lastPub IInboxPublicationHeader, numDelayedPublications *big.Int, proof []byte, periodId *big.Int) (*types.Transaction, error) {
	return _IProverManager.Contract.Prove(&_IProverManager.TransactOpts, start, end, firstPub, lastPub, numDelayedPublications, proof, periodId)
}
