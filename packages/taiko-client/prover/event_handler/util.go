...
// TODO: EXTRACT METADATA FROM PUBLICATION

// getMetadataFromBatchPacaya fetches the batch meta from the onchain event by the given batch id.
// func getMetadataFromPublication(
// 	ctx context.Context,
// 	rpc *rpc.Client,
// 	publication *minimal.IInboxPublished,
...
// 		new(big.Int).SetUint64(publication.AnchorBlockId),
...
// 		Client:           rpc.L1,
// 		NewTaikoInbox:    rpc.MinimalRollupClients.Inbox,
// 		StartHeight:      new(big.Int).SetUint64(batch.AnchorBlockId),
// 		EndHeight:        endHeight,
// 		OnPublishedEvent: callback,
// 	})
// 	if err != nil {
