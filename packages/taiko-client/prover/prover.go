...
// 	// Channels
// 	chBufferSize := p.protocolConfigs.MaxProposals()
// 	publicationsCh := make(chan *minimal.IInboxPublished, chBufferSize)
...
//
// 	// TODO: ADD event filtering for publications
// 	// Subscriptions
// 	// batchProposedSub := rpc.SubscribePublishedAlethia(&p.rpc.MinimalRollupClients.Inbox.IInboxFilterer, publicationsCh, pubHash)
//
// 	// TODO: ADD SUBSCRIPTIONS FOR TAIKO INBOX
//
...
// 	iter, err := eventIterator.NewPublishedIterator(p.ctx, &eventIterator.PublishedIteratorConfig{
// 		Client:             p.rpc.L1,
// 		NewTaikoInbox:      p.rpc.MinimalRollupClients.Inbox,
